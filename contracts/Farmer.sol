...
contract Farmer is Context, ERC165, IERC721, IERC721Metadata, ZetaInteractor, ZetaReceiver, Errors {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Farmer.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(Farmer.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Farmer.ownerOf(tokenId), to, tokenId);
    }
