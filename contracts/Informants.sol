...
contract Informant is Context, ERC165, IERC721, IERC721Metadata, ZetaInteractor, ZetaReceiver, Errors {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Informant.ownerOf(tokenId);
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        owner = Informant.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(Informant.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Informant.ownerOf(tokenId), to, tokenId);
    }
    ...
    function burn(uint256 tokenId) public{
        ...
        require(Informant.ownerOf(tokenId) == msg.sender, "Not your token");
        _burn(tokenId);
    }
