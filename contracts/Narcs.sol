...
contract Narcs is Context, ERC165, IERC721, IERC721Metadata, ZetaInteractor, ZetaReceiver, Errors {
    ...
    uint256 private constant maxTokens = 299;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Narcs.ownerOf(tokenId);
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(Narcs.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Narcs.ownerOf(tokenId), to, tokenId);
    }
    ...
    function mint(address to) public {
        ...
        require(sequenceNumber.current() <= maxTokens, "Minting cap reached");
